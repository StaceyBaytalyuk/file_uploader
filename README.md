...
6.	Нажать кнопку **Загрузить файлы**, выбрать файл и нажать кнопку **Загрузить**. В качестве примера можно загрузить файлы input1.csv и input2.csv из этого проекта. Теперь, при соблюдении всех требований к файлу (см. параграф 3), данные о файле появятся в разделе **Статистика**, а данные из файла доступны в разделе **Люди**. Доступ к этим разделам совершается через главное меню.
